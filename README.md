...
BRVM_index() 
#> # A tibble: 11 × 5
#>    Indexes                `Previous closing` Closing `Change (%)` Year to Date…¹
#>    <chr>                               <dbl>   <dbl>        <dbl>          <dbl>
#>  1 BRVM-30                             102.    102.         -0.2            0   
#>  2 BRVM - AGRICULTURE                  287.    286.         -0.21          -0.66
#>  3 BRVM - OTHER SECTOR                1357.   1296.         -4.55          -7.32
#>  4 BRVM - COMPOSITE                    204.    203.         -0.07           0.85
#>  5 BRVM - DISTRIBUTION                 367.    367.         -0.14           0.69
#>  6 BRVM - FINANCE                       77.3    77.3        -0.03          -0.66
#>  7 BRVM - INDUSTRY                      97.1    98           0.97           0.92
#>  8 BRVM - PRESTIGE                     106.    106.         -0.29           0   
#>  9 BRVM - PRINCIPAL                     96.2    96.4         0.19           0   
#> 10 BRVM - PUBLIC SERVICES              485.    484.         -0.25           2.23
#> 11 BRVM - TRANSPORT                    357.    356.         -0.34           0.35
#> # … with abbreviated variable name ¹​`Year to Date Change`
```
