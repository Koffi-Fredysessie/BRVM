...
Lets take a look at a simple function that receives no argument and returns informations about BRVM market activities

```{r brvm_market_activity}
...
BRVM_ticker_desc function receives no argument and returns informations about BRVM exchange companies.
