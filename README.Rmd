...
library(htmlwidgets)
=======
>>>>>>> 8dc631c1d4ae2452337eb1cd779801915c22c514
```
...
saveWidget(chart, "man/figures/Bicc_ohcl.html", selfcontained = TRUE)
```
...
saveWidget(chart, "man/figures/tickers_graph.html", selfcontained = TRUE)
```
